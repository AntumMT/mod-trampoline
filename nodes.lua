...
minetest.register_node('trampoline:regular', {
	...
	groups = {dig_immediate=2, bouncy=trampoline.bounce*trampoline.multi, fall_damage_add_percent=-100},
})
...
minetest.register_node('trampoline:brown', {
	...
	groups = {dig_immediate=2, bouncy=trampoline.bounce*trampoline.multi_brown, fall_damage_add_percent=-100},
})
