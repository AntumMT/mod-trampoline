...
minetest.register_node('trampoline:regular', {
	...
	groups = {dig_immediate=2, bouncy=trampoline.bounce*5, fall_damage_add_percent=-70},
})
...
minetest.register_node('trampoline:brown', {
	...
	groups = {dig_immediate=2, bouncy=trampoline.bounce*6, fall_damage_add_percent=-70},
})
